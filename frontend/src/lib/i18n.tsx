...
const STRINGS = {
  fa: {
    ...
    sellerHints: "فروشنده‌های در انتظار",
    sellerHintsHint: "از پیامک رمز پویا — به خرید بعدی می‌چسبد",
    resolve: "ثبت دستی",
  ...
  en: {
    ...
    sellerHints: "Sellers waiting",
    sellerHintsHint: "From a purchase OTP — attaches to the next withdrawal",
